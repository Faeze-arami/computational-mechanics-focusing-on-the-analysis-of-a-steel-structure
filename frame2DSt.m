...
%Function M(x) for the Element 14 (floor beam (b))
c1=du(27);
c2=du(26);
c3=du(25);
%(1343854277104299*x)/17592186044416 - (25*x^2)/2 - 4209321003841999/70368744177664

syms x
M=(5457627495765285*x)/70368744177664 - (25*x^2)/2 - 2197389874917699/35184372088832;
phiD=vpa(subs(int(M/(dPar(11,1)*dPar(11,3))),x,l1/2)+c1)

phiDsyms=int(M/(dPar(11,1)*dPar(11,3)))+c1;
vD=vpa(subs(int(phiDsyms),x,l1/2)+c2)

ux=((dNVM(11,1)*(l1/2))/(dPar(11,1)*dPar(11,2)))+c3
