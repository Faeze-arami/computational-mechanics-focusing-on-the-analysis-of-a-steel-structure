...
dpq_const=  [1, 0,    0;
             ...
             15, 0,    0;
             16, 0,    0;
             17,  +sin(alfa)*(cos(alfa)*12.5), -cos(alfa)*(cos(alfa)*12.5);
             18,  -sin(alfa)*(cos(alfa)*12.5), -cos(alfa)*(cos(alfa)*12.5);
             19,  -sin(alfa)*(cos(alfa)*12.5), -cos(alfa)*(cos(alfa)*12.5)];
...
syms x
dpq_var=  [1, 0, 6*((x)/(h1+h2+h3));
           2, 0, 6*((x+h1)/(h1+h2+h3));
           3, 0,  0;
           4, 0, 0;
           5, 0, 6*((x+h1+h2)/(h1+h2+h3));
           6, 0, 3*((x)/(h1+h2+h3));
           7, 0, 3*((x+h1)/(h1+h2+h3));
           8, 0, 3*((x+h1+h2)/(h1+h2+h3)); 
           9, 0, 0;
           10, 0, 0;
           11, 0, 0;
           12, 0, 0;
